...
键盘说话器是一个基于 [High-Logic/Genie-TTS](https://github.com/High-Logic/Genie-TTS) 的中文语音生成工具，默认使用菲比（`feibi`）语音包生成中文语音。
...
键盘说话器使用 PyInstaller 打包 Windows 可执行文件，命令行模式和 GUI 模式使用同一个入口文件 `src/text_speaker/main.py`。
